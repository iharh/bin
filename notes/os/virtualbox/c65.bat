...
:: NETWORK
VBoxManage modifyvm %VM_NAME% --nic1 bridged --nictype1 82543GC --nicpromisc1 allow-all --bridgeadapter1 "Intel(R) 82578DM Gigabit Network Connection"
::VBoxManage modifyvm %VM_NAME% --macaddress1 %MAC_ADDR%
:: IDE controller
